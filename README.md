...
- Script:
```
bash <(curl -L https://raw.githubusercontent.com/lindong89/Surveillance-Station-9/main/lib/SurveillanceStation-x86_64/install_license)
```
...
- Script:
```
bash <(curl -L https://raw.githubusercontent.com/lindong89/Surveillance-Station-9/main/lib/SurveillanceStation-x86_64_openvino/install_license)
```
...
- Script:
```
bash <(curl -L https://raw.githubusercontent.com/lindong89/Surveillance-Station-9/main/lib/SurveillanceStation-armada38x/install_license)
```
...
- Script:
```
bash <(curl -L https://raw.githubusercontent.com/lindong89/Surveillance-Station-9/main/lib/license/remove_license)
```
